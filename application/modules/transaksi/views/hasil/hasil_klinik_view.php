          ...
          <table id="itemsTable" class="table table-bordered table-striped">
            ...
            <tr>
              ...
              <td align="center">
                ...
                ?>
                  <a href="<?php echo base_url('transaksi/hasil_klinik/update/'.$value->nopendaftar); ?>" type="submit" class="btn btn-xs btn-warning">Hasil</a>
                  <a href="<?php echo base_url('transaksi/hasil_klinik/cetak/'.$value->nopendaftar); ?>" type="submit" class="btn btn-xs btn-info">Cetak</a>
                <?php
                }
                ?>
              </td>
