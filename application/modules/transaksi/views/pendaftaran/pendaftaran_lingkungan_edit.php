          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-3">
                ...
                <input type="text" class="form-control pull-right" id="nama" value="<?php echo $header->nama; ?>">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-2">
                <input type="date" class="tanggal form-control pull-right" id="tgl_diterima" value="<?php echo substr($header->tgl_diterima,0,10); ?>">
              </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-2">
                <input type="date" class="tanggal form-control pull-right" id="tgl_selesai" value="<?php echo substr($header->tgl_selesai,0,10); ?>">
              </div>
            </div>
            <div class="form-group">
              <label for="inputEmail3" class="col-sm-2 control-label">Jenis Analisa</label>
              <div class="col-sm-5">
                <input type="text" class="form-control" id="jns_analisa" placeholder="Jenis Analisa" value="<?php echo substr($header->jns_analisa,0,10); ?>">
              </div>
            </div>
            <!-- <div class="form-group">
