        ...
        <form class="form-horizontal">
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-5">
                <input type="text" class="form-control" id="metode_analisa" placeholder="Motode Analisa">
              </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-5">
                <input type="text" class="form-control" id="jumlah" placeholder="Jumlah Pengecekan">
              </div>
            </div>
            <div class="form-group">
              <label for="inputEmail3" class="col-sm-2 control-label">Zoder</label>
              <div class="col-sm-5">
                <input type="text" class="form-control" id="zoder" placeholder="Zoder">
              </div>
            </div>
            <div class="form-group">
