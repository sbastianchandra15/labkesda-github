        ...
        <form class="form-horizontal">
          <div class="box-body">
            <div class="form-group">
              ...
              <div class="col-sm-5">
                <input type="text" class="form-control" id="nama" placeholder="Nama Parameter" value="<?php echo $detail->nm_parameter; ?>">
                <input type="hidden" class="form-control" id="kd_parameter" placeholder="Nama Parameter" value="<?php echo $detail->kd_parameter; ?>">
              </div>
            </div>
            <div class="form-group">
